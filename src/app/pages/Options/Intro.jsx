...
export const Intro = () => {
    ...
    return (
            ...
            >
        {
            ...
            (<>
            <h4 className={s.par}>
            My name is Gerardo Guarda Acosta, also known as Gwerh on GitHub. I am a Fullstack Web Developer, Soundman and Designer oriented to the post-production of audiovisual content and 3D printing. Also, I have participated in various collective projects that have permeated me with capacities and aptitudes within the joint work of diverse groups, both in their composition and in their functional structure, from companies to work cooperatives.            </h4>
            <h4 className={s.par}>
